            ...
            <div style={{ display:'flex', alignItems:'center'}}>
              ...
              <div style={{ flexGrow:1, maxWidth: '500px', marginLeft:'1em', marginBottom:'0.75em' }}>
                <Text className={classes.description} size="sm">
                  Panitia Pemilihan Raya (Papera) merupakan badan independen yang dibentuk oleh Dewan Perwakilan Mahasiswa (DPM) untuk menyelenggarakan Pemilihan Raya (Pemira) dalam rangka memilih DPM, Sema, serta Ketua Tingkat periode selanjutnya sesuai dengan AD/ART Imapolstat.
                </Text>
              </div>
            </div>
