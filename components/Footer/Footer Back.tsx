...
export default function Footer({ withNavbar }: FooterProps) {
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <div className={classes.logoSection}>
                ...
                {theme.colorScheme === 'dark' ? (
                  ...
                  >
                    <Image
                      src="https://pemira.stis.ac.id/assets/img/home/Logo_Papera.png"
                      width="75px"
                      height="75px"
                    />
                  </div>
              ...
              >
                <Text className={classes.description} size="sm">
                  Panitia Pemilihan Raya (Papera) merupakan badan independen yang dibentuk oleh
                  Dewan Perwakilan Mahasiswa (DPM) untuk menyelenggarakan Pemilihan Raya (Pemira)
                  dalam rangka memilih DPM, Sema, serta Ketua Tingkat periode selanjutnya sesuai
                  dengan AD/ART Imapolstat.
                </Text>
              </div>
            </div>
