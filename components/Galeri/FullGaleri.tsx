...
import { Button, SegmentedControl, useMantineTheme } from '@mantine/core';
...
export const FullGaleri = () => {
    ...
    },
    {
      id: 20,
      title: "Ketua Tingkat",
      imageSrc: 'https://pemira.stis.ac.id/assets/img/postingan/1602580479_b8ef15e9765c85742b80.jpg',
    },
    {
      id: 21,
      title: "Ketua Tingkat",
  ...
  const containerClass1 = theme.colorScheme === 'dark' ? 'container-fullgaleri-dark' : 'container-fullgaleri-light';
  const backgroundColorContainer1 = theme.colorScheme === 'dark' ? '#1A1A2E' : '#eaeaea';
  const backgroundColorContainer2 = theme.colorScheme === 'dark' ? '#16213E' : '#f5f5f5';

  return (
    <div className={`container-fullgaleri ${containerClass1}`} style={{ backgroundColor: backgroundColorContainer1 }}>
      ...
      <div className="container-fluid">
        <div className={`border-fullgaleri ${containerClass1}`} style={{ backgroundColor: backgroundColorContainer2 }}>
